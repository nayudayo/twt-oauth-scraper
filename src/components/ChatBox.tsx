    ...
    <>
      ...
      <div className="flex flex-col w-full min-h-screen pt-16 sm:pt-20 px-2 sm:px-4 pb-6 gap-4 mobile-layout">
        ...
        <div className="w-full backdrop-blur-md bg-black/40 border border-red-500/10 rounded-lg shadow-2xl hover-glow ancient-border rune-pattern overflow-hidden">
          ...
          {/* Chat Header */}
            <div className="flex-none flex items-center justify-between px-3 sm:px-4 py-3 sm:py-4 bg-black/40 backdrop-blur-sm border-b border-red-500/10 rounded-t-lg cryptic-shadow">
            ...
            <div className="flex-1 overflow-y-auto custom-scrollbar p-2 sm:p-3 space-y-4 backdrop-blur-sm bg-black/20 ancient-scroll">
              {!analysis ? (
      ...
      <div className="hidden md:block lg:hidden">
        <div className="flex flex-col gap-4 px-4 pb-6">
          {/* Top Section - Chat */}
          <div className="h-[60vh] w-full backdrop-blur-md bg-black/40 border border-red-500/10 rounded-lg shadow-2xl hover-glow ancient-border rune-pattern overflow-hidden">
            <div className="flex flex-col h-full">
              ...
              {/* Chat Messages */}
              <div className="flex-1 overflow-y-auto custom-scrollbar backdrop-blur-sm bg-black/20 ancient-scroll">
              {!analysis ? (
                <div className="text-red-500/70 italic text-center glow-text">
                  Start personality analysis to begin chat interaction
                </div>
              ...
              {/* Chat Input */}
              {analysis && (
                <div className="flex-none p-4 border-t border-red-500/10 bg-black/40 backdrop-blur-sm cryptic-shadow">
                  <form onSubmit={handleSubmit} className="flex gap-2">
                  <textarea
                    ref={textareaRef}
                    value={input}
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-4">
              {/* System Controls Panel */}
              <div className="w-full bg-black/40 backdrop-blur-md border border-red-500/10 rounded-lg shadow-2xl hover-glow ancient-border rune-pattern">
                <div className="flex-none border-b border-red-500/10 p-4 bg-black/40 backdrop-blur-sm cryptic-shadow">
                  <div className="flex items-center gap-2 mb-4">
                    <div className="w-1.5 h-1.5 rounded-full bg-red-500 shadow-lg shadow-red-500/20" />
                    <h3 className="text-sm font-bold text-red-500/90 tracking-wider ancient-text">SYSTEM CONTROLS</h3>
